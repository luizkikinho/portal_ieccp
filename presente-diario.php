...
<head>
    ...
    <title>Presente Diário — IECCP</title>
...
<body>
    <header>
        ...
        <nav aria-label="Navegação principal">
            ...
            <a href="/presente-diario" style="color: var(--secondary);">Presente Diário</a>
    ...
    <main class="section-wrap">
        <div class="page-header">
            <div class="section-kicker">Devocional</div>
            <h1>Presente Diário</h1>
            <p>Edificação diária para sua vida espiritual. Mensagens da RTM Brasil.</p>
        </div>
                        ...
                        <article class="card">
                            <a href="<?= e($link) ?>" class="card-link">
                                <div class="card-media">
                                    <img src="<?= e($img) ?>" alt="<?= e($titulo) ?>" loading="lazy" onerror="this.onerror=null;this.src='/img/capa-padrao-pd.jpg';">
                                    <span class="badge"><?= e($data) ?></span>
                                </div>
                                <div class="card-body">
                                    <h3 class="card-title"><?= e($titulo) ?></h3>
                                    <?php if ($resumoRaw): ?>
                                        <p class="pd-summary"><?= e($resumoRaw) ?></p>
                                    <?php endif; ?>
                                    <span class="read-more" style="margin-top: auto;">Ler devocional <i class="fa-solid fa-arrow-right"></i></span>
                                </div>
                            </a>
                        </article>
            <?php
                    ...
                    echo "<p style='grid-column: 1/-1; text-align: center; color: var(--muted);'>Nenhum devocional encontrado.</p>";
                }
            } catch (PDOException $e) {
                echo "<p style='grid-column: 1/-1; text-align: center; color: var(--muted);'>Erro ao carregar devocionais.</p>";
            }
            ?>
        </div>
    </main>
